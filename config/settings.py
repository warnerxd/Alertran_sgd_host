...
TIEMPO_ESPERA_RECUPERACION    = int(_saved.get("TIEMPO_ESPERA_RECUPERACION",    4000))
TIEMPO_ESPERA_NAVEGACION      = int(_saved.get("TIEMPO_ESPERA_NAVEGACION",      3000))
...
TIEMPO_ESPERA_VOLVER          = int(_saved.get("TIEMPO_ESPERA_VOLVER",          5000))
